...
def make_plot_for_all(df,title,xLabel,yLabel,width, is_log):
    ...
    if is_log:
        plt.yscale('log')
    plt.xticks(x + width, depths, fontsize=12)
...
bfs_max_dep_df, dfs_max_dep_df, astar_max_dep_df,max_dep_data=make_data_frames('max_recursion_depth')
    ...
    # ogółem
make_plot_for_all(max_dep_data,'Średnia liczba maksymalnej głębokości\n rekursji dla różnych strategii','Głębokość','Średnia liczba maksymalnej\n głębokości rekursji',0.25,False)

    # bfs
make_distinct_plot(params, bfs_max_dep_df, 'Średnia liczba maksymalnej głębokości\n rekursji dla algorytmu BFS','Głębokość', 'Średnia liczba maksymalnej\n głębokości rekursji', 0.1,False)

    # dfs
make_distinct_plot(params, dfs_max_dep_df, 'Średnia liczba maksymalnej głębokości\n rekursji dla algorytmu DFS','Głębokość', 'Średnia liczba maksymalnej\n głębokości rekursji', 0.1,False)

    # astr
make_distinct_plot(astar_params, astar_max_dep_df, 'Średnia liczba maksymalnej głębokości\n rekursji dla algorytmu A*','Głębokość', 'Średnia liczba maksymalnej\n głębokości rekursji', 0.4,False)

# czas trwania procesu obliczeniowego
bfs_time_df, dfs_time_df, astar_time_df,time_data=make_data_frames('max_recursion_depth')

    # ogółem
make_plot_for_all(time_data,'Średnia długość czasu trwania procesu\n obliczeniowego dla różnych strategii','Głębokość','Średnia długość czasu trwania procesu\n obliczeniowego',0.25, False)

    # bfs
make_distinct_plot(params, bfs_time_df, 'Średnia długość czasu trwania procesu\n obliczeniowego dla strategii algorytmu BFS','Głębokość', 'Średnia długość czasu trwania procesu\n obliczeniowego', 0.1, False)

    # dfs
make_distinct_plot(params, dfs_time_df, 'Średnia długość czasu trwania procesu\n obliczeniowego dla strategii algorytmu DFS','Głębokość', 'Średnia długość czasu trwania procesu\n obliczeniowego', 0.1, False)

    # astr
make_distinct_plot(astar_params, astar_time_df, 'Średnia długość czasu trwania procesu\n obliczeniowego dla strategii algorytmu A*','Głębokość', 'Średnia długość czasu trwania procesu\n obliczeniowego', 0.4, False)
